...
TEST(EU4World_ProvinceManagerTests, provincesCanBeDiscardedAndWarnedWhenAccessing)
{
	...
	EXPECT_TRUE(theProvinceManager.isProvinceDiscarded(2)); // We're discarding provinces outside political ownership sphere.
	EXPECT_TRUE(theProvinceManager.isProvinceDiscarded(3)); // We're discarding provinces outside political ownership sphere.
