...
TEST(V3World_ProductionMethodTests, ProductionMethodLoadsPMData)
{
	...
	input << "\tgoods_output_small_arms_add = 10\n";
	input << "\t}\n";
	input << "\t}\n";
	...
	EXPECT_THAT(PM.getOutputs(), testing::UnorderedElementsAre(std::make_pair("coal", 90), std::make_pair("grain", 10), std::make_pair("small_arms", 10)));
}