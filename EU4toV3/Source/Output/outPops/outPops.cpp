...
void OUT::outStatePops(std::ostream& output, const V3::State& state)
{
...
void OUT::outSubStatePops(std::ostream& output, const V3::SubState& subState)
{
...
void OUT::outPop(std::ostream& output, const V3::Pop& pop)
{
	output << "\t\t\tcreate_pop = {\n";
